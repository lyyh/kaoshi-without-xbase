...
/**
 * 学生学习时的每道题信息
 * Created by liuyanhao on 2016/3/18 0018.
 */
public class SubjectInfoVo {
    ...
    private List<String> stuBlankAnswer; //填空题答案
    ...
    public List<String> getStuBlankAnswer() {
        return stuBlankAnswer;
    }

    public void setStuBlankAnswer(List<String> stuBlankAnswer) {
