...
/* modified */
if(tt.hasClass("tree-hit") || tt.hasClass("caret")){
_13b(_d8,_dc[0]);
return false;
}else{
...
var ul=$(_135).next();
/* modified */
hit.parent().parent().removeClass('tree-p-collapsed')  //*
if(ul.length){
if(opts.animate){
...
var ul=$(_13a).next();
hit.parent().parent().addClass('tree-p-collapsed')
if(opts.animate){
...
$(_182).find(".tree-node-p-selected").removeClass("tree-node-p-selected");
$(_183).addClass("tree-node-selected");
$(_183).parents('li').addClass("tree-node-p-selected");
...
cc.push("<span class=\"tree-hit tree-collapsed\"><span class='caret'></span></span>");
cc.push("<span class=\"tree-icon tree-folder "+(item.iconCls?item.iconCls:"ficon-folder-close-alt")+"\"></span>");
}else{
if(item.children&&item.children.length){
/* modified */
cc.push("<span class=\"tree-hit tree-expanded\"><span class='caret'></span></span>");
cc.push("<span class=\"tree-icon tree-folder tree-folder-open "+(item.iconCls?item.iconCls:"ficon-folder-close-alt")+"\"></span>");
}else{
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"tree-icon tree-file "+(item.iconCls?item.iconCls:"ficon-file-text-alt")+"\"></span>");
_1ba=true;
}
}
if(opts.checkbox){
...
opts.onMouseOverRow.call(_64c,_64d,row);
